...
INSERT INTO `request` (`id`,`request`,`phonenumber`,`email`,`requestdate`,`responsedate`,`status`) VALUES
('4','request request request request request ','0788543321','ntabanacoco@gmail.com','2014-09-25','2014-09-26','3');
INSERT INTO `request` (`id`,`request`,`phonenumber`,`email`,`requestdate`,`responsedate`,`status`) VALUES
('12','ndifuza kumenya amazina yanjye','078865432','ntabanacoco@gmail.com','2014-09-25','2014-09-26','1');
INSERT INTO `request` (`id`,`request`,`phonenumber`,`email`,`requestdate`,`responsedate`,`status`) VALUES
...
('23','1','<p>kkkkkkkkkkkkkkkkkkkkkkkk</p>','2014-09-26');
INSERT INTO `response` (`id`,`idrequest`,`response`,`response_date`) VALUES
('24','4','<p>what?</p>','2014-09-26');
INSERT INTO `response` (`id`,`idrequest`,`response`,`response_date`) VALUES
('25','1','<p>i like it</p>','2014-09-26');
INSERT INTO `response` (`id`,`idrequest`,`response`,`response_date`) VALUES
('26','1','<p>lflflf</p>','2014-09-26');
INSERT INTO `response` (`id`,`idrequest`,`response`,`response_date`) VALUES
('27','1','<p>ddldldl</p>','2014-09-26');
INSERT INTO `response` (`id`,`idrequest`,`response`,`response_date`) VALUES
('28','1','<p>ldldldl</p>','2014-09-26');
INSERT INTO `response` (`id`,`idrequest`,`response`,`response_date`) VALUES
('29','1','<p>ldldldldl</p>','2014-09-26');
INSERT INTO `response` (`id`,`idrequest`,`response`,`response_date`) VALUES
('30','3','<p>;fd\';fdf\'\';df\';fd\';</p>','2014-09-26');
INSERT INTO `response` (`id`,`idrequest`,`response`,`response_date`) VALUES
('31','3','<p>gogogogog</p>','2014-09-26');
INSERT INTO `response` (`id`,`idrequest`,`response`,`response_date`) VALUES
('32','4','<p>lflflflflfllfflfl</p>','2014-09-26');
INSERT INTO `response` (`id`,`idrequest`,`response`,`response_date`) VALUES
('33','4','<p>ntabana coco ntabana coco</p>','2014-09-26');
INSERT INTO `response` (`id`,`idrequest`,`response`,`response_date`) VALUES
('34','1','<p>lkk</p>','2014-09-26');
INSERT INTO `response` (`id`,`idrequest`,`response`,`response_date`) VALUES
('35','1','<p>lkk</p>','2014-09-26');
INSERT INTO `response` (`id`,`idrequest`,`response`,`response_date`) VALUES
('36','1','<p>lkk</p>','2014-09-26');
INSERT INTO `response` (`id`,`idrequest`,`response`,`response_date`) VALUES
('37','3','<p>k</p>','2014-09-26');
