...
('1','ndifuza kumenya iby imisoro','0788543310','cntabana@yahoo.fr','2014-09-23','0000-00-00','1');
INSERT INTO `request` (`id`,`request`,`phonenumber`,`email`,`requestdate`,`responsedate`,`status`) VALUES
('2','Ndibaza ikibazo kijyanye n imisoro n amahoro.murakoze','0788598432','kruddy@yahoo.fr','2014-09-24','','0');
INSERT INTO `request` (`id`,`request`,`phonenumber`,`email`,`requestdate`,`responsedate`,`status`) VALUES
('3','Ndifuza kumenya uko amahoro ameze','0788654321','kntabana@yahoo.fr','2014-09-24','','1');
INSERT INTO `request` (`id`,`request`,`phonenumber`,`email`,`requestdate`,`responsedate`,`status`) VALUES
('4','request request request request request ','0788543321','test@yahoo.fr','2014-09-25','','0');
INSERT INTO `request` (`id`,`request`,`phonenumber`,`email`,`requestdate`,`responsedate`,`status`) VALUES
('12','ndifuza kumenya amazina yanjye','078865432','cntabana@yahoo.fr','2014-09-25','','0');
INSERT INTO `request` (`id`,`request`,`phonenumber`,`email`,`requestdate`,`responsedate`,`status`) VALUES
('13','ndifuza kumenya amazina yanjye','078865432','cntabana@yahoo.fr','2014-09-25','','0');
