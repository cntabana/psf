    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        <li>
                            <a href="#">
                                <div>
                                    <i class="fa fa-comment fa-fw"></i> New Request
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="?r=user/changePasswordUser&p=profile"><i class="fa fa-user fa-fw"></i> User Profile</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="?r=site/logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                ...
                ?>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="?r=request/newRequest">New Requests</a>
                                </li>
                                <li>
                                    <a href="?r=request/archive">Open Requests</a>
                                </li>
                                <li>
                                    <a href="?r=request/underProcess">Under Process Requests</a>
                                </li>
                                <li>
                                    <a href="?r=request/closed">Closed Requests</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="?r=userRequests/sent">Sent</a>
                                </li>
                                <li>
                                    <a href="?r=response">Responses</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                ...
                <?} else{ ?>
                <li>
                      <a href="?r=site/login"> <i class="fa fa-sign-out fa-fw"></i> Login</a>
                    </li>
            <?}?>
                    </ul>
                </div>
