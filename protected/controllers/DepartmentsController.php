...
class DepartmentsController extends CController
{
        public $breadcrumbs;
	/**
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Departments']))
		{
                 ...
                 $session['Departments_records']=Departments::model()->findAll($criteria); 
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Departments_records']))
               {
                $model=$session['Departments_records'];
               }
               else
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->LastPage();
		$pdf->Output("Departments_002.pdf", "I");
	}
}
